...
import Ui.WF_ParCurveGui_2016     as ParCurveGui
  
from Utils.Gui import DefineAndConnectEvents
from Utils.Gui import print_msg
...
#import FreeCADGui.getMainWindow
import Draft
import Part
...
def f2(fa,fb,fx,fy,t,i,msgBox):
    ...
    return fxx, fyy        
        ...
        for i in range(dmax):
            ...
            fxx, fyy = f2(fa,fb,fx,fy,t,i,self.msgBox)
...
class ParametricCurve3D(Parametric):
    ...
    def draw_par_function(self,fa ,fb, fc):
        ...
        code = """
def f3(fa,fb,fc,fx,fy,fz,t,i,msgBox):
    value=""
    #msgBox = QtGui.QMessageBox()
    try: 
        value="a() = """+str(fa)+""""
    ...
    return fxx, fyy, fzz       
        ...
        for i in range(dmax):
            ...
            fxx, fyy, fzz = f3(fa,fb,fc,fx,fy,fz,t,i,self.msgBox)
...
# 
    ...
    def draw_par_function(self, fa ,fb, fc):
        ...
        code = """
def f3(fa,fb,fc,fx,fy,fz,u,v,msgBox):
    value=""
    try: 
        value="a() = """+str(fa)+""""
        a="""+str(fa)+"""
    ...
    return fxx, fyy, fzz       
        ...
        for v in np.arange(vmin,vmax,vstep):            
            ...
            for u in np.arange(umin,umax,ustep):
            #for v in np.arange(vmin,vmax,vstep):
                fxx, fyy, fzz = f3(fa,fb,fc,fx,fy,fz,u,v, self.msgBox)
                x, y, z = ox + fxx, oy + fyy, oz + fzz 
                matriz.append(FreeCAD.Vector(x,y,z))
